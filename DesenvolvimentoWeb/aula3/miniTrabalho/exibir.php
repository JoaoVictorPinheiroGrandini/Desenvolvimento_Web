...
<body>
    <?php
        ...
        $array = array_filter($pessoas, function($elem) use ($nome, $cidade, $estado, $idade){
            $idade2 = calculaIdade($elem["dtNascimento"]);
            if((stripos($elem["nome"], $nome) > -1 || $nome == "") && (stripos($elem["cidade"], $cidade) > -1 || $cidade == "") && ($idade == $idade2 || $idade == "") && ($elem["estado"] == $estado || $estado == "")){
                return true;
            }
